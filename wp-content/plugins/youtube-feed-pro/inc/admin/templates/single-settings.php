            ...
            <tr id="post-<?php echo esc_attr( $channel_id ); ?>" class="iedit author-self post-1525 type-sby_channels status-draft hentry entry">
                ...
                <td class="title column-title has-row-actions column-primary page-title" data-colname="Title"><div class="locked-info"><span class="locked-avatar"></span> <span class="locked-text"></span></div>
                    ...
                    <div class="row-actions">
                        ...
                        <span class="sby_publish"><a href="<?php echo admin_url( 'admin.php?page=sby_single_settings' ); ?>&sby_action=publish&channel=<?php echo urlencode( $channel_id ); ?>" aria-label="Publish <?php echo esc_html( $channel_title ); ?>"><?php _e ( 'Publish All' ); ?></a> | </span>
                        <span class="sby_trash"><a href="<?php echo admin_url( 'admin.php?page=sby_single_settings' ); ?>&sby_action=trash&channel=<?php echo urlencode( $channel_id ); ?>" aria-label="Trash <?php echo esc_html( $channel_title ); ?>"><?php _e ( 'Trash All' ); ?></a></span>
                    </div>
                </td>
