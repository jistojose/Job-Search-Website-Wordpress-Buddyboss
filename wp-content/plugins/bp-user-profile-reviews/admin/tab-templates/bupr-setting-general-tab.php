			...
			<tbody>
				...
				<tr>
					<th scope="row">
						<label for="bupr-hide-review-button">
							<?php esc_html_e( 'Hide Review Button', 'bp-member-reviews' ); ?>
						</label>
					</th>
					<td>
						<label class="bupr-switch">
						...
						<p class="description"><?php esc_html_e( 'Enable this option if you want to show Add Review button on member profile.', 'bp-member-reviews' ); ?></p>
					</td>
				</tr>
				<tr>
					<th scope="row">
				...
				<tr>
					...
					<td>
						...
						<p class="description"><?php esc_html_e( 'Enable this option, if you want that member to receive an email when someone adds review in their profile.', 'bp-member-reviews' ); ?></p>
					</td>
				</tr>
				<tr>
					<th scope="row">
							...
							foreach ( $user_roles as $role => $details ) {
								...
								if ( ! empty( $bupr['exclude_given_members'] ) ) {
									if ( in_array( $role, $bupr['exclude_given_members'] ) ) {
										?>
											<option value="<?php echo esc_attr( $role ); ?>" <?php echo 'selected = "selected"'; ?>><?php echo $name; ?></option>
										<?php
									} else {
										?>
